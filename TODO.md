...
[#52](https://github.com/forkcloser/xz/pull/52). The new patch v0.5.11 will fix
it.
...
[issue #35](https://github.com/forkcloser/xz/issues/35).

### 2020-02-24

Release v0.5.7 supports the check-ID None and fixes
[issue #27](https://github.com/forkcloser/xz/issues/27).
